...
function EditorPage() {
  ...
  const [selectedAmendmentIndex, setSelectedAmendmentIndex] =
    useState<number>(0); // Track selected amendment
  const [selectedStudyDesignIndex, setSelectedStudyDesignIndex] =
    useState<number>(0); // Track selected study design
  ...
  useEffect(() => {
    if (jsonContent.trim() && isInitialLoad) {
      ...
      if (parsed?.study?.versions?.length > 0) {
        ...
        if (
          parsed.study.versions[parsed.study.versions.length - 1]?.amendments
            ?.length > 0
        ) {
          setSelectedAmendmentIndex(
            parsed.study.versions[parsed.study.versions.length - 1].amendments
              .length - 1
          );
        }
        ...
        if (
          parsed.study.versions[parsed.study.versions.length - 1]?.studyDesigns
            ?.length > 0
        ) {
          setSelectedStudyDesignIndex(
            parsed.study.versions[parsed.study.versions.length - 1].studyDesigns
              .length - 1
          );
        }
    ...
    if (source === 'import' || source === 'example') {
      ...
      if (importedData) {
        try {
          ...
          setLoadingStatus(
            source === 'import'
              ? 'Imported USDM file loaded successfully!'
              : 'Example USDM file loaded successfully!'
          );
          setError(null);
      ...
      <Box sx={{ py: isFullscreen ? 2 : 4 }}>
        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Button
              ...
              disabled={
                !!error || (!jsonDisplayContent.trim() && !jsonContent.trim())
              }
              startIcon={<Download />}
            >
              Export
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} lg={isFullscreen ? 12 : 8}>
            <Card
              sx={{ height: isFullscreen ? 'calc(100vh - 200px)' : '600px' }}
            >
              <CardContent
                sx={{
                  height: '100%',
              ...
              >
                ...
                {parsedUSDM ? (
                  <Box sx={{ flexGrow: 1, overflow: 'auto' }}>
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={12} md={4}>
                            <TextField
                              ...
                              onChange={(e) =>
                                updateUSDMField(['usdmVersion'], e.target.value)
                              }
                            />
                          </Grid>
                          <Grid item xs={12} md={4}>
                            <TextField
                              ...
                              onChange={(e) =>
                                updateUSDMField(['systemName'], e.target.value)
                              }
                            />
                          </Grid>
                          <Grid item xs={12} md={4}>
                        ...
                        <Grid container spacing={2}>
                          ...
                          <Grid item xs={12} md={6}>
                            <TextField
                              ...
                              onChange={(e) =>
                                updateUSDMField(['study', 'id'], e.target.value)
                              }
                            />
                          </Grid>
                          <Grid item xs={12} md={6}>
                        ...
                        <TableContainer>
                          <Table size="small">
                            ...
                            <TableBody>
                              ...
                              {displayValues.study.versions[
                                selectedVersionIndex
                              ].studyIdentifiers?.map(
                                (identifier: any, identifierIndex: number) => (
                                ...
                                (reference: any, referenceIndex: number) => (
                                  ...
                                  >
                                    <TableCell>
                                      ...
                                      >
                                        ID -{' '}
                                        {reference?.instanceType || 'Reference'}
                                      </Typography>
                                    </TableCell>
                                    <TableCell>
                                      <TextField
                                        ...
                                        onChange={(e) => {
                                          ...
                                          const textValue =
                                            typeDecode &&
                                            newValue.startsWith(typeDecode)
                                              ? newValue
                                                  .substring(typeDecode.length)
                                                  .trim()
                                              : newValue;
                    ...
                    {/* Study Versions */}
                    {displayValues.study?.versions &&
                      displayValues.study.versions.length > 0 && (
                        <Accordion defaultExpanded>
                          <AccordionSummary expandIcon={<ExpandMore />}>
                          ...
                          <AccordionDetails>
                            <Stack spacing={3}>
                              ...
                              <FormControl fullWidth>
                                ...
                                >
                                  {displayValues.study.versions.map(
                        ...
                        <Accordion defaultExpanded>
                          <AccordionSummary expandIcon={<ExpandMore />}>
                            <Typography variant="h6">
                              ...
                              {displayValues.study.versions[
                                selectedVersionIndex
                              ].amendments[selectedAmendmentIndex] && (
                                <Chip
                                  label={
                                    displayValues.study.versions[
                                      selectedVersionIndex
                                    ].amendments[selectedAmendmentIndex].id ||
                                    `Amendment ${selectedAmendmentIndex + 1}`
                                  }
                                  size="small"
                                  sx={{ ml: 1 }}
                                />
                                          ...
                                          <TableBody>
                                              ...
                                              (
                                                ...
                                                <TableRow key={reasonIndex}>
                                                  ...
                                                  <TableCell>
                                                    ...
                                                    <Typography variant="body2">
                                                      {getDisplayText(
                                                        secondaryReason?.code
                                                          ?.decode,
                                                        secondaryReason?.otherReason
                                                      )}
                                                    </Typography>
                                                  </TableCell>
                                                </TableRow>
                                            ...
                                            {displayValues.study.versions[
                                              ...
                                              (
                                                ...
                                                <TableRow
                                                  key={`enrollment-${enrollmentIndex}`}
                                                >
                                                  <TableCell>
                                                    <Typography
                                                      variant="body2"
                        ...
                        <Accordion defaultExpanded>
                          <AccordionSummary expandIcon={<ExpandMore />}>
                            <Typography variant="h6">
                              ...
                              {displayValues.study.versions[
                                selectedVersionIndex
                              ].studyDesigns[selectedStudyDesignIndex] && (
                                <Chip
                                  label={
                                    displayValues.study.versions[
                                      selectedVersionIndex
                                      ...
                                      .id ||
                                    `Design ${selectedStudyDesignIndex + 1}`
                                  }
                                  size="small"
                                  sx={{ ml: 1 }}
                                />
                                      ...
                                      <Table size="small">
                                        ...
                                        <TableBody>
                                          ...
                                          {displayValues.study.versions[
                                            ...
                                            (area: any, areaIndex: number) => (
                                              <TableRow
                                                key={`therapeutic-area-${areaIndex}`}
                                              >
                                                <TableCell>
                                                  <Typography
                                                    variant="body2"
                  ...
                  >
                    <Box sx={{ textAlign: 'center' }}>
                      ...
                      <Typography variant="body2" color="textSecondary">
                        Import a USDM JSON file or load an example to start
                        editing.
                        <br />
                        The visual editor will show form fields for easy
                        editing.
                      </Typography>
                    </Box>
                  </Paper>
            ...
            <Grid item xs={12} lg={4}>
              ...
              <Card>
                <CardContent>
                  ...
                  <Button fullWidth variant="outlined" sx={{ mb: 2 }} disabled>
